...
public class GithubApiTResult<T> : UpdaterApiResult
{
    /// <summary>
    /// Init new UpdaterApiResult of T with given response message
    /// </summary>
    internal GithubApiTResult(ResponseMessage responseMessage) : base(responseMessage) { }

    /// <summary>
    /// Init new UpdaterApiResult of T with given response message and more thorough explanation about status
    /// </summary>
    ...
    /// <summary>
    /// Init new UpdaterApiResult of T with given response message and content of T
    /// </summary>
